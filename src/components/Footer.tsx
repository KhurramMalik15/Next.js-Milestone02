...
const Footer = () => {
  return (
    <footer className="bg-gray-900 font-sans text-white py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* footer header */}
        <div className="text-center mb-12">
          <h2 className="text-4xl font-sans font-bold text-red-900">Get In Touch</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-8 text-center mb-12">
          <div>
            <h3 className="font-semibold mb-4 text-xl text-red-900">Quick Links</h3>
            <ul>
          ...
          <div>
            <h3 className="font-semibold mb-4 text-xl text-red-900">Contact</h3>
            <ul>
          ...
          <div> 
            <h3 className="font-semibold mb-4 text-xl text-red-900">Follow Us</h3>
          ...
          <div>
            <h3 className="font-semibold mb-4 text-xl text-red-900">Address</h3>
